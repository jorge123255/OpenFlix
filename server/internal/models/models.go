...
type LibraryPath struct {
	...
	ConsecutiveMissingScans int        `gorm:"default:0" json:"consecutiveMissingScans"`
...
type MediaItem struct {
	...
	Edition        string  `gorm:"size:100" json:"edition,omitempty"` // e.g. "4K HDR10", "1080p HEVC", "Director's Cut"
...
type Channel struct {
	...
	// Stream codec info (populated from HDHR lineup or M3U headers)
	VideoCodec string `gorm:"size:20" json:"videoCodec,omitempty"` // h264, hevc, mpeg2, etc.
	AudioCodec string `gorm:"size:20" json:"audioCodec,omitempty"` // aac, ac3, eac3, etc.
...
type Recording struct {
	...
	ActualDurationSec float64 `gorm:"default:0" json:"actualDurationSec,omitempty"`
	Redundant         bool    `gorm:"default:false" json:"redundant"`
	BackupFilePath    string  `gorm:"size:2000" json:"backupFilePath,omitempty"`
	// Retry handling
...
type SeriesRule struct {
	...
	Redundant bool `gorm:"default:false" json:"Redundant"` // record on two streams for reliability
