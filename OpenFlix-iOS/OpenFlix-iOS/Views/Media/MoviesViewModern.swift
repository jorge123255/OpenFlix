        ...
        ScrollView(.vertical, showsIndicators: false) {
            LazyVStack(alignment: .leading, spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 48) {
                    ...
                    // Genres
                    ForEach(viewModel.genreHubs.prefix(5), id: \.genre) { hub in
                        if selectedGenre == nil || selectedGenre == hub.genre {
                            ModernMovieRow(
                                title: hub.genre,
                                subtitle: nil,
                    ...
                    // TODO: Collections (not yet in ViewModel)
                    // TODO: Studios/Services (not yet in ViewModel)
                }
                .padding(.top, 40)
        ...
        ZStack {
            ...
            TabView(selection: $currentIndex) {
                ForEach(Array(movies.prefix(6).enumerated()), id: \.element.id) { index, movie in
                    TheaterModeHeroItem(
                        movie: movie,
                        hasTrailer: trailers[movie.id] != nil,
                        ...
                        GeometryReader { geo in
                            ZStack(alignment: .leading) {
                                ...
                                Rectangle()
                                    ...
                                    .frame(width: geo.size.width * item.progressPercent, height: 4)
                            }
                        }
                        .frame(height: 4)
                    }
...
// Safe Array subscript defined in PlayerViewModel.swift
