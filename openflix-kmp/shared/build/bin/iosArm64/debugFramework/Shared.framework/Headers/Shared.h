 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)testConnectionWithCompletionHandler:(void (^)(SharedBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("testConnection(completionHandler:)")));
